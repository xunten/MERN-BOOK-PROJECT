...
const EditBooks = () => {
  ...
  const handleUpdate = (event) => {
    ...
    fetch(`http://localhost:5000/book/${id}`, {
      ...
      // console.log(data)
      alert("Book is update sucessfully!!!")
    })
  }
  return (
    <div className='px-4 mt-12'>
      ...
      <form onSubmit={handleUpdate} className="flex lg:w-[1180px] flex-col flex-wrap gap-4">
        ...
        <div>
          ...
          <Textarea id="bookDescription" name="bookDescription" placeholder="Wirte your book description..." required rows={6} className="w-full" defaultValue={bookDescription}/>
        </div>
